...
export default function Page() {
  return (
    <>
      ...
      <div className='links'>
      <div className='linkContent'><a href='https://www.maimaimfc.ink/'>MMFC主站</a></div>
      <div className='linkContent'><a href='https://www.maimaimfc.ink/forum'>MMFC论坛</a></div>
      <div className='linkContent'><a href='https://www.bing.com/images/search?q=%e7%8c%aa%e8%84%9a&form=HDRSC4&first=1'>在线看脚</a></div>
